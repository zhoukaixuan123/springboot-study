...
<%@ taglib uri="/hangyjx-view" prefix="view"%>
...
<link rel="stylesheet" type="text/css" href="<%=webapp%>/style/css/style.css"/>
<link rel="stylesheet" type="text/css" href="<%=webapp%>/style/css/external.min.css"/>
<link rel="stylesheet" type="text/css" href="<%=webapp%>/style/css/popup.css"/>
<script src="<%=webapp%>/style/js/jquery.1.10.1.min.js" type="text/javascript"></script>
<script type="text/javascript" src="<%=webapp%>/style/js/jquery.lib.min.js"></script>
<script src="<%=webapp%>/style/js/ajaxfileupload.js" type="text/javascript"></script>
<script type="text/javascript" src="<%=webapp%>/style/js/additional-methods.js"></script>
<!--[if lte IE 8]>
    <script type="text/javascript" src="<%=webapp%>/style/js/excanvas.js"></script>
<![endif]-->
<script type="text/javascript">
